...
public class Meme implements Comparable<Meme>  {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Meme> memeList2 = new ArrayList<Meme>();
        memeList2.add(meme1);
        memeList2.add(meme2);
        memeList2.add(meme1);
        memeList2.add(meme2);
        ...
        //CompareMemeByRating
        Collections.sort(memeList1, new CompareMemeByCreator());
        System.out.println(memeList1);

        Collections.sort(memeList2, new CompareMemeByCreator());
        System.out.println(memeList2);

        //CompareMemeByRating
        Collections.sort(memeList1, new CompareMemeByRating());
        System.out.println(memeList1);

        Collections.sort(memeList2, new CompareMemeByRating());
        System.out.println(memeList2);
    }
